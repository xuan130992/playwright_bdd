Feature: I create a new official mod
  Scenario Outline: I create a ne official mod successful
    ...
    Examples:
      ...
      |1.0.1|1|Eng_online_mod_1|Eng_des_mod_1|xpath=(//*[@class="p-button-label" and contains(text(),"Upload")])[1]|./tests/resourse/modfile/17_optimized.png|xpath=(//*[@class="p-button-label" and contains(text(),"Upload")])[3]|./tests/resourse/modfile/Modfile.unity3d|xpath =(//*[@class="p-button-label" and contains(text(),"Upload")])[3]|./tests/resourse/modfile/Modfile.unity3d|xpath=(//*[@class="p-button-label" and contains(text(),"Upload")])[3]|./tests/resourse/modfile/Modfile.unity3d|xpath=(//*[@class="p-button-label" and contains(text(),"Upload")])[3]|./tests/resourse/modfile/Modfile.unity3d|
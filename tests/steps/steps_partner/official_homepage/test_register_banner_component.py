...
def input_all_fields(register_banner_component_page,commonFunctions_page,display_order:str,link:str,upload_locator_PC:str,filepath_PC:str,upload_locator_mobile:str,filepath_mobile:str):
    ...
    register_banner_component_page.component_name_created= register_banner_component_page.component_name
...
def verify_register_banner_component(commonFunctions_page,register_banner_component_page):
    commonFunctions_page.verify_register_new_component_successful(register_banner_component_page.component_name)
@then('I can see New component in main displayed')
def verify_register_banner_component_displayed(main_displayed_page,register_banner_component_page):
    main_displayed_page.open_main_page()
    main_displayed_page.verify_register_banner_component_displayed(register_banner_component_page.component_name)

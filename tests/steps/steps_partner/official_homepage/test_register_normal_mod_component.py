...
from tests.pages.partners_page.official_homepage.register_normal_mod_component_page import register_normal_mod_component
...
scenarios("../../../features/partners/official_homepage/register_normal_mod_component.feature")
@pytest.fixture
...
@pytest.fixture
def register_normal_mod_page(page):
    return register_normal_mod_component(page)
@pytest.fixture
...
def select_manual_registration_method(register_normal_mod_page):
    register_normal_mod_page.select_manual_registration()

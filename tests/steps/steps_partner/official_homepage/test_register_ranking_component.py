...
from tests.pages.partners_page.official_homepage.register_ranking_component_page import register_ranking_component
...
scenarios("../../../features/partners/official_homepage/register_ranking_component.feature")
@pytest.fixture
...
@pytest.fixture
def register_ranking_component_page(page):
    return register_ranking_component(page)
@pytest.fixture
...
@when(parsers.cfparse('I select country "{country}" and clicks Register Component button'))
...
def select_Aggregation_period(register_ranking_component_page):
    register_ranking_component_page.select_Aggregation_Period()

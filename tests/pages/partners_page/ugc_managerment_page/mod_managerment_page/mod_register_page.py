...
class mod_register:
    def __init__(self,page:Page):
        ...
        self.english_oneline_description= self.iframe.get_by_label('One Line Description ')
        self.english_description= self.iframe.locator('//*[@placeholder="Please enter within 500 characters."]')
        ...
        self.confirm_btn2=self.iframe.locator('//*[contains(text(),"Confirm") and @class="p-button-label"]')
        self.mod_name= f'mod_name_{self.random_suffix}'
        self.keywork_value=f'keywork{self.random_suffix}'
    ...
    def register_official_mod(self,package_version,ingame_display_order,eng_oneline_description,eng_description):
        ...
        self.keyword.fill(self.keywork_value)

...
class mod_register:
    def __init__(self,page:Page):
        ...
        self.package_version= self.iframe.locator('(//*[@placeholder="Please enter within 30 characters."])[2]')
        ...
        self.english_title= self.iframe.locator('(//*[@placeholder="Please enter within 30 characters."])[3]')

...
class register_common_component:
    ...
    def select_component_type_page(self,component_type:str):
        component_type_locator= self.iframe.locator(f"//*[@class='rounded-br-10 rounded-tl-10 color-white text-18 inline-block w-auto bg-black px-24 py-8' and text()='{component_type}']")

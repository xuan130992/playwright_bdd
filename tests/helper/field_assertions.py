...
def fill_validation(com_loc:component_common_locators,banner_loc:component_hero_banner_locators,mod_loc:register_mod_component,field:str):
    actions={
        ...
        "component title":lambda: mod_loc.en_language_component_title.fill("checking require field"),
...
def get_error_locator(com_loc:component_common_locators,banner_loc:component_hero_banner_locators,mod_loc:register_mod_component,field:str):
    field_error_locator_map = {
        "Title": lambda : com_loc.missing_title,
        "Display Period": lambda : com_loc.invalid_display_period,
        "Banner": lambda :banner_loc.missing_banner,
        ...
        "component title": lambda : mod_loc.missing_component_title,
        "mod register":lambda: mod_loc.missing_mod_list
